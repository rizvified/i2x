...
var setInitialFieldState = function setInitialFieldState(field, key) {
  ...
  if (key === '$form') {
    return (0, _createField.updateFieldState)(_initialFieldState2.default, {
      value: field.value,
      model: field.model
    });
  }
...
function formActionsReducer(state, action, localPath) {
  ...
  switch (action.type) {
    ...
    case _actionTypes2.default.RESET:
      {
        return localPath.length ? (0, _assocIn2.default)(state, localPath, resetFieldState(field)) : resetFieldState(field);
      }
