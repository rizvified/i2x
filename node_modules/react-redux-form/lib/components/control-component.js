  ...
  var Control = function (_Component) {
    ...
    _createClass(Control, [{
      ...
      value: function getChangeAction(event) {
        ...
        var value = this.isToggle() ? getToggleValue(this.props) : event;
            ...
            case _actionTypes2.default.FOCUS:
              {
                ...
                if (focused && _this2.node.focus && (!_this2.isToggle() || typeof intent.value === 'undefined' || intent.value === controlProps.value)) {
                  _this2.node.focus();
      ...
      value: function validate(options) {
        ...
        if (!(0, _shallowEqual2.default)(errors, fieldValue.errors)) {
          ...
          dispatch(_actions2.default.clearIntents(options.clearIntents));
        }
